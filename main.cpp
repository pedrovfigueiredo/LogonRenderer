...
int main()
{
    ...
    objects.push_back(new Object("Floor","/Users/PedroFigueiredo/Downloads/OBJs_baixados/floor3.obj", new Diffuse(glm::vec3{0.3,0.3,0.3}), new Transformations(2, {}, {0,0,0})));
    objects.push_back(new Object("BackWall","/Users/PedroFigueiredo/Downloads/OBJs_baixados/floor3.obj", new Diffuse(glm::vec3{0.3,0.3,0.3}), new Transformations(2, {new Transformations::Rotation{Transformations::Axis::X, 270}}, {0,1,-1})));
    ...
    objects.push_back(new Object("Monkey", "/Users/PedroFigueiredo/Downloads/OBJs_baixados/monkey90.obj", new  SmoothDieletric(1.526, glm::vec3{8.0f, 8.0f, 3.0f}), new Transformations(1.2, {new Transformations::Rotation{Transformations::Axis::Y, 0}}, {0,0.8,2})));
    objects.push_back(new Object("Monkey2", "/Users/PedroFigueiredo/Downloads/OBJs_baixados/monkey90.obj", new  SmoothDieletric(1.526, glm::vec3{3.0f, 8.0f, 8.0f}), new Transformations(1.2, {new Transformations::Rotation{Transformations::Axis::Y, 0}}, {-1,1,1})));
    objects.push_back(new Object("Monkey3", "/Users/PedroFigueiredo/Downloads/OBJs_baixados/monkey90.obj", new  SmoothDieletric(1.526, glm::vec3{8.0f, 3.0f, 8.0f}), new Transformations(1.2, {new Transformations::Rotation{Transformations::Axis::Y, 0}}, {1,1,1})));
