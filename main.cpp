...
int main()
{
    ...
    objects.push_back(new Object("Monkey", "/Users/PedroFigueiredo/Downloads/OBJs_baixados/monkey90.obj", new  RoughConductor(0.05, glm::vec3{0.95, 0.93, 0.88}), new Transformations(1.2, {}, {0,0.8,1})));
