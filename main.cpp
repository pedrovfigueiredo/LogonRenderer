...
int main()
{
    ...
    //objects.push_back(new Object("Floor","/Users/PedroFigueiredo/Downloads/OBJs_baixados/floor3.obj", new Diffuse(glm::vec3{0.3,0.3,0.3}), new Transformations(1, {}, {0,0,0})));
    //objects.push_back(new Object("BackWall","/Users/PedroFigueiredo/Downloads/OBJs_baixados/floor3.obj", new Diffuse(glm::vec3{0.3,0.3,0.3}), new Transformations(2, {new Transformations::Rotation{Transformations::Axis::X, 90}}, {0,1,-1})));
    ...
    //objects.push_back(new Object("Monkey", "/Users/PedroFigueiredo/Downloads/OBJs_baixados/monkey90.obj", new  SmoothDieletric(), new Transformations(1.2, {new Transformations::Rotation{Transformations::Axis::Y, 45}}, {-1,0.8,1})));
