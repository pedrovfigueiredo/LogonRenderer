...
int main()
{
    ...
    objects.push_back(new Object("Monkey", "/Users/PedroFigueiredo/Downloads/OBJs_baixados/monkey90.obj", new  SmoothDieletric(1.526, glm::vec3{8.0f, 8.0f, 3.0f}), new Transformations(1.2, {new Transformations::Rotation{Transformations::Axis::Y, 0}}, {0,0.8,1.5})));
    //objects.push_back(new Object("Golden_Dragon","/Users/PedroFigueiredo/Downloads/OBJs_baixados/dragon_recon/dragon_vrip.ply", new SmoothDieletric(0.05, glm::vec3{1.00, 0.71, 0.29}), new Transformations(10, {}, {0,0.7,0.4})));
