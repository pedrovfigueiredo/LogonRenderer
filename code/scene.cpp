...
//        glm::vec3{ -0.9f, 0.7f, 0.6f }, 0.025f } ) );
    ...
    primitives_.push_back(Primitive::PrimitiveUniquePtr(new Triangle{ new LightSource(glm::vec3{1.0f,1.0f,1.0f}), glm::vec3{1.0f,2.0f,1.0f}, glm::vec3{0.0f,2.0f,2.0f}, glm::vec3{-1.0f,2.0f,1.0f} }));
    
    primitives_.push_back(Primitive::PrimitiveUniquePtr(new Triangle{ new Diffuse(glm::vec3{255.0f,0.0f,0.0f}), glm::vec3{-0.7f,0.0f,0.0f}, glm::vec3{-1.2f,0.5f,0.0f}, glm::vec3{-1.7f,0.0f,0.0f} }));
    
    primitives_.push_back(Primitive::PrimitiveUniquePtr(new Triangle{ new Diffuse(glm::vec3{0.0f,255.0f,0.0f}), glm::vec3{0.5f,0.0f,0.0f}, glm::vec3{0.0f,0.5f,0.0f}, glm::vec3{-0.5f,0.0f,0.0f} }));
    
    primitives_.push_back(Primitive::PrimitiveUniquePtr(new Triangle{ new Diffuse(glm::vec3{0.0f,0.0f,255.0f}), glm::vec3{1.7f,0.0f,0.0f}, glm::vec3{1.2f,0.5f,0.0f}, glm::vec3{0.7f,0.0f,0.0f} }));
